...
function resetScore() {
  ...
  const html = document.querySelector('.js-yes-or-not');
  const question = '<p>Are you sure you want to reset the score? <button class="js-yes-button">Yes</button><button class="js-no-button">No</button></p>';
